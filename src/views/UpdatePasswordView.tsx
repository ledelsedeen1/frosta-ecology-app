...
const copy = {
  no: {
    ...
    linkError: 'Lenken for tilbakestilling av passord er ugyldig eller utløpt. Be om en ny lenke.',
  ...
  pl: {
    ...
    linkError: 'Link resetowania hasła jest nieprawidłowy lub wygasł. Poproś o nowy link.',
  ...
  en: {
    ...
    linkError: 'The password reset link is invalid or expired. Please request a new link.',
